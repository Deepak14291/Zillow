        ...
        <div class="md:col-span-5 flex flex-col gap-4">
            ...
            <Box>
                ...
                <input v-model.number="interestRate" type="range" min="0.1" max="30" step="0.1"
                    class="w-full h-4 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"></input>
                ...
                <div class="text-gray-600 dark:text-gray-300 mt-2">
                    ...
                    <div class="mt-2 text-gray-500">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                <Price :price="interestPaid" class="font-medium"></Price>
                            </div>
                        </div>
                    </div>
            ...
            <MakeOffer v-if="user" :listing-id="listing.id" :price="listing.price"></MakeOffer>
        </div>
    </div>
</template>
<script setup>
...
import { ref } from 'vue'
import { useMonthlyPayment } from '../Components/Composables/newMonthlyPayment';
...
const { monthlyPayment, totalPaid, interestPaid } = useMonthlyPayment(props.listing.price, interestRate, duration)
